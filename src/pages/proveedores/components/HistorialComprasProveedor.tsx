          ...
          {compras.map((compra) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className="font-bold text-primary">{formatMoneda(compra.total)}</span>
            ...
            <tbody>
              ...
              onClick={() => navigate(`${RUTAS.ADMIN.COMPRAS}/${compra.id}`)}
                ...
                >
                  ...
                  <td className="py-3 text-sm font-bold text-primary text-right">{formatMoneda(compra.total)}</td>
