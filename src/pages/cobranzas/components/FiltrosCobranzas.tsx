      ...
      <div className="flex flex-col md:flex-row gap-2">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-sm text-gray-900 placeholder-gray-400 outline-none bg-gray-50 rounded-lg focus:ring-2 focus:ring-blue-200"
          />
        </div>
        ...
        <select
          ...
          className="px-3 py-2 bg-gray-50 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 min-w-[140px]"
        >
